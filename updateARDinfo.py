...
# https://jss.collemcy.com:8443/JSSResource/computers/serialnumber/C02TC14TH040
# https://jss.collemcvoy.com:8443/JSSResource/computers/serialnumber/C02TC14TH040
jssAPIuser = 'jss_api_read'
jssAPIpass = 'drags-4-fracken!'
##
## jssURL = 'https://' + jssAPIuser + ':' + jssAPIpass + \
##    '@jss.server.com:8443'
##
jssURL = 'https://jss.collemcvoy.com' + jssAPIuser + ':' + jssAPIpass + \
'@jss.server.com:8443'
print jssURL
