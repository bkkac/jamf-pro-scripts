...
defaults write /Users/$curUser/Library/Preferences/ByHost/com.apple.screensaver.$macUUID.plist moduleDict -dict moduleName "XXXXX" path "/Library/Screen Savers/XXXX.saver" type -int 0
