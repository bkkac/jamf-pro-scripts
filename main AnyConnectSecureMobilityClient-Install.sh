...
# Variables
applicationTitle="Cisco AnyConnect Secure Mobility Client" # Firefox no .app
customTrigger="provision_anyConnect" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
appPath="Applications/Cisco" ## Leave blank if /Applacations
appIcon="vpngui.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
