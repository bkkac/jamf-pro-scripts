...
# Variables
applicationTitle="PCClient" # Firefox no .app
customTrigger="provision_PCClient" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
appPath="" ## Leave blank if /Applacations
appIcon="client-icon.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
