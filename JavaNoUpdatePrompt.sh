#!/bin/sh
# Most of this script from: https://jamfnation.jamfsoftware.com/discussion.html?id=6489
# With help from :  https://foigus.wordpress.com/2015/02/20/managing-java-7-and-8-updates/
# WHP 151118

# Make the Deployment folder
mkdir -p /Library/Application\ Support/Oracle/Java/Deployment
