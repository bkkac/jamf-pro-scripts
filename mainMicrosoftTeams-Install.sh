...
# Variables
applicationTitle="Microsoft Teams" # Firefox no .app
customTrigger="provision_microsoftTeams" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
appPath="" ## Leave blank if /Applacations
appIcon="icon.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
