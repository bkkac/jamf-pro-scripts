...
# ABOUT THIS PROGRAM
# NAME
#	oneDriveSettings.sh ADD Enabling users to add additional work or school accounts -- Set the prefs for OneDrive=
#
# SYNOPSIS
...
#	Version: 1.0
#
#	- Created by Will Pierce on 160210
#	- 
#
####################################################################################################
#
...
#
echo "Running oneDriveSettings_add additional work or school accounts.sh version 1.0"
