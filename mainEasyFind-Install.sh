...
# Variables
applicationTitle="EasyFind" # Firefox no .app
#
customTrigger="provision_EasyFind" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
#
appPath="" ## Leave blank if /Applacations
#
appIcon="EasyFind.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
#
