...
TAG=\$(/usr/bin/osascript -e 'tell application "System Events" to set TAG to text returned of (display dialog "Please Input Computer Name - " default answer "afurkin13mbp666" with icon 2)')
