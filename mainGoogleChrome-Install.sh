...
# Variables
applicationTitle="Google Chrome" # Firefox no .app
customTrigger="provision_googlechrome" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
appPath="" ## Leave blank if /Applacations
appIcon="app.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
