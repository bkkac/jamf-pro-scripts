...
*          removes v1.0.0 thru v6.0.2           *
*        on osx 10.4.11 thru osx 10.11.3        *
*              kbeck@extensis.com               *
*                  2016-0324                    *
*************************************************
TITLE
...
1) remove all universal type client files, all versions, from all users acccounts, except logs
...
for USERDIR in $USERS; do
	...
	sudo rm -rf /Users/"$USERDIR"/Library/Preferences/com.extensis.* > /dev/null 2>&1 
	...
	# "/Users/$USERDIR/.Extensis" > /dev/null 2>&1
	# /Users/$USERDIR/.UTCore" > /dev/null 2>&1
	# /Users/$USERDIR/Library/Preferences/com.extensis.FontManagement.plugins.* > /dev/null 2>&1
	# /Users/$USERDIR/Library/Preferences/com.extensis.utcore-prefpane.plist" > /dev/null 2>&1
	# "/Users/$USERDIR/Library/Preferences/com.extensis.UniversalTypeClient.db" > /dev/null 2>&1
	# "/Users/$USERDIR/Library/Preferences/com.extensis.UniversalTypeClient.plist" > /dev/null 2>&1
	# /Users/$USERDIR/Library/Preferences/com.extensis.UniversalType.plugins.* > /dev/null 2>&1
	# "/Users/$USERDIR/Library/Preferences/UTCorePrefs.db" > /dev/null 2>&1
	# "/Users/$USERDIR/Library/Caches/FMCore" > /dev/null 2>&1
...
### remove illustrator CS2, CS3, CS4, CS5, CS 5.5 (aka 5.1), CS6, CC (aka CS7), CC 2014 and CC 2015
...
### remove incopy CS4, CS5, CS 5.5 (aka 5.1), CS6, CC (aka CS7), CC 2014 and CC 2015
...
### remove indesign CS2, CS3, CS4, CS5, CS 5.5, CS6, CC (aka CS7), CC 2014 and CC 2015
...
### remove photoshop CS4, CS5, CS 5.5 (aka 5.1), CS6, CC (aka CS7), CC 2014 and CC 2015
...
### remove QXP7, QXP8, QXP9, QXP10 and QXP2015 plug-ins
...
# remove the font panels with a wild card
echo "Removing $APP font panels . . ."
# for adobe CC 2014 & CC 2015:
...
# remove receipts for osx 10.6 thru 10.11
