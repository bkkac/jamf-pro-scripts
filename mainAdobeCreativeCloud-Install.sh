...
# Variables
applicationTitle="Adobe Creative Cloud" # Firefox no .app
#
customTrigger="provision_creativeCloud" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
#
appPath="Applications/Utilities/Adobe Creative Cloud/ACC" ## Leave blank if /Applacations
#
appIcon="CreativeCloud.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
#
...
log=/Users/Shared/Provisiong-log.txt
#
app_IconPath=/Applications/Utilities/Adobe\ Creative\ Cloud/ACC/Creative\ Cloud.app/Contents/Resources/CreativeCloud.icns
## Verbose
echo "######### ##########"
...
#
version=$(mdls -name kMDItemVersion /Applications/Utilities/Adobe\ Creative\ Cloud/ACC/Creative\ Cloud.app | cut -c 19- | rev | cut -c 2- | rev)
