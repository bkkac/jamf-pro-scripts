...
# Variables
applicationTitle="NoMAD" # Firefox no .app
customTrigger="provision_NoMAD" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
appPath="" ## Leave blank if /Applacations
appIcon="AppIcon.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
