...
# Variables
applicationTitle="Firefox" # Firefox no .app

customTrigger="provision_firefox" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
appPath="" ## Leave blank if /Applacations
appIcon="firefox.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
...
log=/Users/$user/Desktop/Provisiong-log.txt
