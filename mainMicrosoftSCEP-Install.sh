...
# Variables
applicationTitle="System Center Endpoint Protection" # Firefox no .app
customTrigger="provision_microsoftSCEP" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
appPath="" ## Leave blank if /Applacations
appIcon="gui_icon.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
