...
#
customTrigger="provision_recon" # The name of the cuntom Trigger for the Provisiong policy:  provision_firefox
#
appPath="/Applications/Utilities" ## Leave blank if /Applacations
#
appIcon="Recon.icns" ## Find the icon name in: "/"$appPath"/"$applicationTitle".app/Contents/Resources/
#
